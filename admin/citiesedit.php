...
<div class="col-md-12 col-lg-12 mt-2"style="margin-left:20px;" >
        ...
        <h2>Cities</h2>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 mt-5">
              ...
              <input type="text" class="form-control" name="citiesname"  value="<?php echo $Data[1];  ?>" id="user" placeholder="Enter a City Name"  required>
...
if(isset($_POST["submit"])){
  ...
  $Update="UPDATE `cities` SET `cityName`='$CitiesName' WHERE `cityid`='$CityId'";
