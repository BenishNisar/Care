...
<body>
 ...
 <a style="text-decoration:none;color:white;" href="hospitaldataform.php"> <button class="btn btn-primary" style="width:150px;color:white;background-color:blue;border-top:1px solid white;border-right:1px solid white;border-bottom:1px solid white;border-left:1px solid white;border-radius:3px;text-decoration:none;margin-right:1px;border-radius:10px;">Add New</button></a>
  </div>
...
<tr class="text-dark">
 ...
 <td><a href="hospitaldatadelete.php?id=<?php echo $Data[0]; ?>"><button class="btn btn-primary">Delete</button></a></td>
