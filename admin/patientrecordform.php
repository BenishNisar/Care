      ...
      <div class="col-md-6 col-lg-6"style="margin-left:20px;" >
        ...
        <div class="row g-3">
          <div class="col-sm-12 col-md-12 col-lg-12">
              ...
              <input type="text" class="form-control" name="firstname" id="text" placeholder="Enter a First Name"  required>
...
<label class="text-dark" for="content">Last Name</label>
              <input type="text" class="form-control" name="lastname" id="text" placeholder="Enter a Last Name"  required>
            ...
            <div class="col-sm-12">
              ...
              <input type="email" class="form-control" name="email" id="source" placeholder="Enter a email"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-12">
              ...
              <input type="text" class="form-control" name="disease" id="text" placeholder="Enter a Disease Name"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
...
if(isset($_POST["submit"])){
   ...
   $Query="INSERT INTO `patientrecord`(`id`, `firstname`, `lastname`, `dateofbirth`, `gender`,
    `email`, `phonenumber`, `address`, `disease`) VALUES (
   NULL,
   '$FirstName','$LastName','$DateOfBirth',
   '$Gender','$Email','$PhoneNumber','$Address','$Disease')";
