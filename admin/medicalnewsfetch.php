...
?>
   <script>
        var images = ["./images/medicalnews.jpg", "./images/medicalnewstwo.jpg", "./images/medicalthree.jpeg"]; // Array of image sources
        var imageIndex = 0; 
