      ...
      <div class="col-md-12 col-lg-12"style="margin-left:20px;" >
        ...
        <div class="row g-3">
          <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="text" class="form-control" name="doctor" value="<?php echo $Data[1]; ?>" id="user" placeholder="Enter a Doctor Name"  required>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="file" class="form-control" name="doctorprofile"  value="<?php echo $Data[2]; ?>" id="user" placeholder="Enter a Disease Name"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="text" class="form-control" name="firstname"  value="<?php echo $Data[3]; ?>" id="user" placeholder="Enter a First Name"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="text" class="form-control" name="lastname"  value="<?php echo $Data[4]; ?>" id="user" placeholder="Enter a Last Name"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="email" class="form-control" name="email"  value="<?php echo $Data[7]; ?>"  value="<?php echo $Data[0]; ?>" id="user" placeholder="Enter Your Email"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
    ...
    <label for="password" class="form-label">Password</label>
        <div class="input-group">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <!-- <input type="text" class="form-control" name="text"  id="text" placeholder="Enter  "  required> -->
              
              <Select class="form-control" name="city"  value="<?php echo $Data[11]; ?>">
              <?php
...
if (isset($_POST["submit"])) {
    ...
    $Update ="UPDATE `doctoraccount` SET `username`='$DoctorName',`doctorprofile`='$DoctorProfile',`firstname`='$FirstName',`lastname`='$LastName',`specialty`='$Specialty',`image`='$Image',`email`='$Email',`password`='$Password',`phonenumber`='$PhoneNumber',`address`='$Address',`city`='$City' WHERE `id`='$Id'";
