...
<div class="row g-3">
  <div class="col-sm-12 col-md-12 col-lg-12">
      ...
      <input type="text" class="form-control" name="title" value="<?php echo $Data[1];  ?>" id="text" placeholder="Title"  required>
...
<label class="text-dark" for="content">Sub Title</label>
      <input type="text" class="form-control" name="subtitle" value="<?php echo $Data[2];  ?>" id="text" placeholder="Enter a Last Name"  required>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <textarea name="description" class="form-control" value="<?php echo $Data[3];  ?>" rows="5"  style="min-height:300px;"></textarea>
      <div class="invalid-feedback">
        Valid first name is required.
      </div>
    </div>
...
<input type="button" value="button" value="<?php echo $Data[4];  ?>" name="button">
      <div class="invalid-feedback">
        Valid first name is required.
      </div>
    </div>
    ...
    <div class="col-sm-12">
      ...
      <input type="file" class="form-control" name="sliderimage" value="<?php echo $Data[5];  ?>" id="text" placeholder="Enter a PhoneNumber"  required>
      <div class="invalid-feedback">
        Valid first name is required.
      </div>
    </div>
...
if(isset($_POST["submit"])){
    ...
    `descripation`='$Description',`button`='$Button',`img`='$Sliderimage' WHERE `id`='$Id'";
