      ...
      <div class="col-md-6 col-lg-6"style="margin-left:20px;" >
        ...
        <div class="row g-3">
          <div class="col-sm-12 col-md-12 col-lg-12">
              ...
              <input type="text" class="form-control" name="title" value="<?php echo $Data[1] ?>" id="text" placeholder="Text."  required>
            ...
            <div class="col-sm-12 col-md-12">
              ...
              <textarea class="form-control" name="descripation"  value="<?php echo $Data[2] ?>" rows="10"></textarea>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-12">
              ...
              <input type="file" class="form-control" name="image" value="<?php echo $Data[3] ?>" id="text" placeholder="Enter a PhoneNumber"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
