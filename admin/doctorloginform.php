...
<form action="#" method="POST"  class="needs-validation" novalidate>
    <h1>Hospitals Form</h1>
          ...
          <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="text" class="form-control" name="username" id="user" placeholder="Enter a Hospital Name"  required>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="text" class="form-control" name="email" id="user" placeholder="Enter a Area"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <input type="text" class="form-control" name="password" id="user" placeholder="Enter a Area"  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
...
if (isset($_POST["submit"])) {
  ...
  $Email = $_POST["email"];
   $Password=$_POST["password"];
    ...
    $Query ="INSERT INTO `doctorlogin`(`id`, `username`, `email`, `password`) VALUES (
