...
$Query = "SELECT `id`, `username`, `email`, `password` FROM `login` WHERE `email`='$Email' AND `password`='$Password'";
...
if(mysqli_num_rows($Response)){
    ...
    echo "<script>window.location.href='./login.php?invalid';</script>";
